...
exports.OAuth = (function (global) {
    ...
    OAuth.prototype = {
        ...
        init: function (options) {
             ...
             *      formdata {boolean} If true then the data will be sent as form data
             *
             *		If a field name in data contains a $ then the $ and anything
			 *		following it will be truncated. This is to allow multiple
                ...
                if(appendQueryString || method == 'GET') {
                    ...
                    if (typeof data == 'string') {
                        ...
                        for(i in data) {
                            ...
                            query.push(OAuth.urlEncode(n) + '=' + OAuth.urlEncode(data[i] + ''));
                        }
